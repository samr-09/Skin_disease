...
function useCreateMotionContext(props) {
  var _a = getCurrentTreeVariants(props, (0, import_react9.useContext)(MotionContext)), initial = _a.initial, animate3 = _a.animate;
...
function MeasureLayout(props) {
  ...
  return import_react28.default.createElement(MeasureLayoutWithContext, __assign({}, props, { layoutGroup, switchLayoutGroup: (0, import_react28.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
function useForceUpdate() {
  ...
  var _a = __read((0, import_react29.useState)(0), 2), forcedRenderCount = _a[0], setForcedRenderCount = _a[1];
  useUnmountEffect(function() {
...
var PresenceChild = function(_a) {
  ...
  var context = (0, import_react30.useMemo)(
    function() {
      return {
        id: id3,
        initial,
...
function MotionConfig(_a) {
  ...
  config = __assign(__assign({}, (0, import_react34.useContext)(MotionConfigContext)), config);
...
function LazyMotion(_a) {
  ...
  var _c = __read((0, import_react35.useState)(!isLazyBundle(features)), 2), setIsLoaded = _c[1];
...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    var _a = __read((0, import_react38.useState)(initial), 2), setLatest_1 = _a[1];
...
function ReorderItem(_a, externalRef) {
  ...
  return React10.createElement(Component, __assign({ drag: axis }, props, { dragSnapToOrigin: true, style: __assign(__assign({}, style), { x: point.x, y: point.y, zIndex }), layout: true, onDrag: function(event, gesturePoint) {
...
function useReducedMotion() {
  ...
  var _a = __read((0, import_react44.useState)(prefersReducedMotion.get()), 2), shouldReduceMotion = _a[0], setShouldReduceMotion = _a[1];
...
function useAnimatedState(initialState) {
  var _a = __read((0, import_react48.useState)(initialState), 2), animationState = _a[0], setAnimationState = _a[1];
